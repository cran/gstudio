...
%\VignetteIndexEntry{Genetic Summaries}
...
\begin{figure}[bth]
	\centering
	\includegraphics{GeneticSummaries-araptus_he}
...
\begin{enumerate}
	\item Can you plot allele frequencies as a function of latitude araptus data set?  Are there any blatant gradients?
\end{enumerate}
